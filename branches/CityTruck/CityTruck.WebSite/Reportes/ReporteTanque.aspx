<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteTanque.aspx.cs" Inherits="CityTruck.WebSite.Reportes.ReporteTanque" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="600px" 
        ...
        <LocalReport ReportPath="Reportes\ReporteTanque.rdlc">
            <DataSources>
