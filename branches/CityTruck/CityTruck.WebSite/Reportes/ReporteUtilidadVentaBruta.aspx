<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteUtilidadVentaBruta.aspx.cs" Inherits="CityTruck.WebSite.Reportes.ReporteUtilidadVentaBruta" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="600px" 
        ...
        <LocalReport ReportPath="Reportes\ReporteUtilidadVentaBruta.rdlc">
            <DataSources>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="ReporteUtilidadVentaBruta" 
