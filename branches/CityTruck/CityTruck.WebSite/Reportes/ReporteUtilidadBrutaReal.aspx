<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteUtilidadBrutaReal.aspx.cs" Inherits="CityTruck.WebSite.Reportes.ReporteUtilidadBrutaReal" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="600px" 
        ...
        <LocalReport ReportPath="Reportes\ReporteUtilidadBrutaReal.rdlc">
            <DataSources>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="ReporteUtilidadBrutaReal" 
