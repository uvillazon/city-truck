Ext.define("App.View.Reportes.Reportes", {
    ...
    initComponent: function () {
        ...
        if (me.opcion == "ReporteAutoridad") {
            me.textGuardar = "Generar Reporte Autoridad";
            me.CargarReporteAutoridad();
...
//        }
    ...
    GuardarReporte : function(){
        ...
        if (me.opcion == "ReporteAutoridad"){
            ...
            if(me.formReporte.isValid()){
                window.open(Constantes.HOST + 'Reportes/ReporteEstadoResultado?ANIO='+me.cbx_anio.getValue() + '&MES='+me.cbx_mes.getValue());
                me.hide();
            }
            else{
                Ext.Msg.alert("Error","Falta Completar informcion...");
